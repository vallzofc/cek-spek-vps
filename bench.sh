...
#!/usr/bin/env bash
#
# Description: A Bench Script by Vallzofc
#
# Copyright (C) 2015 - 2024 Vallzofc <i@Vallzofc.com>
...
print_intro() {
    echo "-------------------- A Cek Spek Script By VallzOfficial -------------------"
    echo " Version            : $(_green v2024-11-11)"
    echo " Usage              : $(_red "bash <(curl https://raw.githubusercontent.com/vallzofc/cek-spek-vps/refs/heads/main/bench.sh)")"
}
